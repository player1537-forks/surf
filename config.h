...
static char *useragent      = "Mozilla/5.0 (X11; Fedora; Linux x86_64; rv:49.0) Gecko/20100101 Firefox/49.0 Surf/"VERSION;
...
#define DOWNLOAD(d, r) { \
	.v = (char *[]){ "/bin/sh", "-c", \
	     "cd ~/downloads && st -e /bin/sh -c \"curl -g -L -J -O --user-agent '$1'" \
	     " --referer '$2' -b $3 -c $3 '$0';" \
	     " sleep 5;\"", \
...
static Key keys[] = {
	...
	{ MODKEY,               GDK_slash,  spawn,      SETPROP("_SURF_FIND", "_SURF_FIND") },
        ...
        { MODKEY,               GDK_Return,  handlehtml5, { 0 } },
...
static char *searchengine   = "https://www.google.com/search?btnG=Search&gbv=1&q=";
